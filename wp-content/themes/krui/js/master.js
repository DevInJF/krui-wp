jQuery(document).ready(function() {
  ...
  /*
  * Commented out due to lack of use of the lab in 2015-08.  
  * Comment this function in to enable lab playlist, and the call in the next section. 
  *
    function labLatest() {
        jQuery.ajax({
            type: 'GET',
  ...
  jQuery.ajax({
        ...
        success: function(playlist) {
            ...
            //labLatest(); //comment this call in to enable lab playlist
        }
  });
